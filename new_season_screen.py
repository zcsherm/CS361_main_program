...
class AddSeasonScreen(tk.Toplevel):
    def __init__(self,master=None, data=None):
        ...
        self._games = tk.Spinbox(frame4,from_=3,to=99, increment=3, textvariable=self._games_var)
        ...
        self._team = tk.Checkbutton(frame6,text="Add Initial Team",variable=self._team_var, onvalue=1,offvalue=0)
        self._team.pack()
        ...
        self._return_button.pack(side='bottom', padx=10, pady=40)
