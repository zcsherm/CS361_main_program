...
class AddUserScreen(tk.Toplevel):
    """
    Screen that creates a new user of the program
    """
    def __init__(self,master=None, data=None):
        ...
        self.title("New User")
        self._master=master
        Pmw.initialise(self._master.root) # Allows for hover text
        ...
        # Set up add and return buttons and bind hot keys
    ...
    def add_user(self, event=None):
        """
        Adds the entered user, also asks if the user would like to create an initial season
        """

        # Sets up a question dialog box with hover text
    ...
    def season_add(self, selected):
        """
        Saves the new user and launches the appropriate screen 
        """
